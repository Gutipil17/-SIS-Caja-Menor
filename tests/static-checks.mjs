...
assert.match(app, /const APP_VERSION='1\.9\.9'/);
assert.match(html, /v1\.9\.9/);
assert.match(worker, /sis-gastos-v1\.9\.9/);
assert.equal(JSON.parse(version).version, '1.9.9');
...
console.log('Controles estáticos v1.9.9: OK');
