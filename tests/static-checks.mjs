...
assert.match(app, /const APP_VERSION='1\.9\.8'/);
assert.match(html, /v1\.9\.8/);
assert.match(worker, /sis-gastos-v1\.9\.8/);
assert.equal(JSON.parse(version).version, '1.9.8');
...
console.log('Controles estáticos v1.9.8: OK');
